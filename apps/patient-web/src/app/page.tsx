  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-slate-50">
      ...
      <div className="flex flex-col items-center justify-center text-center">
        <span className="text-teal-600 font-semibold tracking-wider uppercase text-sm mb-2">AyuNet Ecosystem</span>
        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl md:text-6xl mb-6">
          Patient <span className="text-teal-600">Web Portal</span>
        </h1>
        <p className="max-w-md text-slate-500 text-lg mb-8">
          Welcome to the AyuNet Patient portal. This web application connects you to clinical consulting, healthcare records, and diagnostics.
        </p>
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-left gap-6">
        <div className="group rounded-lg border border-slate-200 px-5 py-4 transition-colors hover:border-teal-300 hover:bg-teal-50/20 bg-white shadow-sm">
          ...
          <p className="m-0 max-w-[30ch] text-sm text-slate-500">
            View lab reports, historical diagnostics, and provider summaries.
          </p>
        </div>
        ...
        <div className="group rounded-lg border border-slate-200 px-5 py-4 transition-colors hover:border-teal-300 hover:bg-teal-50/20 bg-white shadow-sm">
          ...
          <p className="m-0 max-w-[30ch] text-sm text-slate-500">
            Schedule virtual or in-person consults with primary care doctors and specialists.
          </p>
        </div>
        ...
        <div className="group rounded-lg border border-slate-200 px-5 py-4 transition-colors hover:border-teal-300 hover:bg-teal-50/20 bg-white shadow-sm">
          ...
          <p className="m-0 max-w-[30ch] text-sm text-slate-500">
            Refill active prescriptions and track delivery from connected caregivers.
          </p>
        </div>
      </div>
    </main>
